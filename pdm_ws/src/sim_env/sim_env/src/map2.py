        ...
        room2_obs_dicts = [
            {
                ...
                'geometry': {
                    'position': [(self.room_size), -(16 - (self.room_size-self.door_size)/2)+0,  self.height / 2.0],
                    'width': self.room_size-self.door_size, 'height': self.height, 'length': 0.1
                }
            },
            {
                ...
                "rgba": [1.0, 0.0, 0.0, 1.0],
                'geometry': {
                    'position': [self.room_size/2-2/2, -(16 - self.room_size + self.door_size)+0,  self.height / 2.0],
                    'width': 0.1, 'height': self.height, 'length': self.room_size-4/2
                }
            },
        ]
