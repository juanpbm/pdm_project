        ...
        room1_obs_dicts = [
            {
                ...
                'geometry': {
                    'position': [self.boundary_size - self.room_size, 0.0 - (self.room_size-self.door_size)/2 +0 , self.height / 2.0],
            ...
            },
            {
                ...
                "rgba": [0.0, 0.0, 1.0, 1.0],
                'geometry': {
                    'position': [self.boundary_size - self.room_size/2 +2/2, 0.0 - self.room_size+self.door_size+0, self.height / 2.0],
