...
static const _BasePlan_type_support_symbol_names_t _BasePlan_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_trials, msg, BasePlan)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robot_trials, msg, BasePlan)),
  }
};
...
{
  return &::robot_trials::msg::rosidl_typesupport_cpp::BasePlan_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, robot_trials, msg, BasePlan)() {
  return get_message_type_support_handle<robot_trials::msg::BasePlan>();
}
